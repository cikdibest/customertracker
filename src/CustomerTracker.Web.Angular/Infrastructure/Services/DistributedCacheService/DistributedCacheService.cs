...
namespace CustomerTracker.Web.Angular.Infrastructure.Services.DistributedCacheService
{
    ...
    public class DistributedCacheService : IDistributedCacheService
    {
        ...
        {
            this.cacheEntries[key] = new CacheEntry(value);
        }
        ...
        public object GetEntry(string key)
        {
            ...
            if (!this.cacheEntries.TryGetValue(key, out cacheEntry)) return null;

            if (cacheEntry.ExpriationTime == null)
                return cacheEntry.Value;

            return this.dateTimeProvider.Now < cacheEntry.ExpriationTime ? cacheEntry.Value : null;
        }
